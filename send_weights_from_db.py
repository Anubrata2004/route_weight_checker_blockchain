...
# === STEP 4: Send Checkpoint Weights ===
print("\n[INFO] Sending Checkpoint Weights:")
...
for log in logs:
    ...
    result = "Match" if args['isMatching'] else "Discrepancy"
    print(f"  Checkpoint {args['checkpointNumber']}: {args['submittedWeight']} kg --> {result}")
